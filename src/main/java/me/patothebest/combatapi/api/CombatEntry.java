...
public class CombatEntry {
    ...
    public CombatEntry(int tick, EntityDamageEvent event) {
        this.tick = tick;
        ...
        if (tempKiller != null) {
            if (tempKiller instanceof Player) {
                ...
                String petOwner = (String) tempKiller.getMetadata("PetOwner").get(0).value();
                if (petOwner != null) {
                    playerKiller = new WeakReference<>(Bukkit.getPlayerExact(petOwner));
                }
            }
